  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 图标 - 完全填满容器 */}
        {imageError ? (
          <span className="fallback-letter text-lg font-medium text-white/70 flex items-center justify-center w-full h-full">
...
export function DockBar() {
  ...
  const handleDoubleClick = async () => {
    ...
    setTimeout(() => setIsRefreshing(false), TIMEOUTS.REFRESH_DEBOUNCE);
  };
